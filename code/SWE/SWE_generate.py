...
# import seaborn #Data visualization on top of matplotlib
# import sys
# import imageio
# from matplotlib import cm

# -------- SET UP SIMULATION PARAMETERS --------
Lx,Ly  = 256, 256                 # 500m x 400m
nx, ny = 128, 128              
...
# Shapiro filter parameter (filters small scale noise)
epsilon = 0.005
dtype=np.float64
...
# def simulation_step_naive(): # Pointwise Euler Framework (doesn't take direction of flow into account, which may lead to num. instabilities)
#     # OMB Eq. (5.1) i-ii:
#     # u_t = -g eta_x
...
#                -(u_x+v_y)*(h0+eta[M,M]); # Central in Space
...
def simulation_step_controlvolume(): #Flux based upwind differentiating
    # OMB Eq. (5.1) i-ii:
    # u_t = -g eta_x
    eta_x = grid0_Dx(eta,dx);
    eta_y = grid0_Dy(eta,dy);
...
smooth_dam_break((30,30),x0=(Lx/3,Ly/3),height=1)
...
np.save("Hannah/SWE_Data/shallow2D_4500_128_128_5.npy",etadata)
