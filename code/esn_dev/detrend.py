...
def upscale(ft,nX,timer=None):
    ct=dct(ft,norm='ortho', axis = 0);
    result = idct(ct,n=nX,norm='ortho', axis = 0);
    return result
...
#--- Calculation of pol trends and cycles ---
...
# --- recombination of the time series
